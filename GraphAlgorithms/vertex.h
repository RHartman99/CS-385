...
struct Vertex {
    ...
    // Explicit means you have to construct the object this way BEFORE calling a function
    // that expects a vertex. If a function takes a vertex, you could implicitly construct a
    // vertex object with an unsigned int.
